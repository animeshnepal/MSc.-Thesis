...
%% REQUIRED PAGES
\include{TEXs/statement} % UNCOMMENT
\cleardoublepage % blank page for twoside print
\include{TEXs/acknowledgements} % UNCOMMENT
\cleardoublepage % blank page for twoside print
...
\include{TEXs/nomenclature} \newpage
\addcontentsline{toc}{chapter}{Abstract}
\include{TEXs/abstractenglish} \newpage % UNCOMMENT
\cleardoublepage % blank page for twoside print
\addcontentsline{toc}{chapter}{Task Description} % UNCOMMENT
\include{TEXs/taskdescription} \newpage % UNCOMMENT
\cleardoublepage % blank page for twoside print
...
%% MAIN PART
\include{TEXs/introduction} % UNCOMMENT
\include{TEXs/literaturereview}% UNCOMMENT
\include{TEXs/governing_equations} % UNCOMMENT
\include{TEXs/modelconcept} % UNCOMMENT
\include{TEXs/results} % UNCOMMENT
\include{TEXs/conclusions} % UNCOMMENT
...
% UNCOMMENT
\begin{appendix}
\include{TEXs/APPENDIXFlowChart}
\include{TEXs/APPENDIXPlots}
\end{appendix}
