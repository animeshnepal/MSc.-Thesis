...
respectively, ${k^{'}}_{1}$ is the forward rate constant for reaction \ref{eq:CaCO3diss} (${k^{'}}_{1}$ is 10-20 
times larger than $k_1$), and the subscript "s" stands for adsorption surface values. 
...
system being closed and opened to the atmosphere in karstic developments. In an opened-system, gaseous \ce{CO2} is dissolved into the water 
...
hence system comes to internal equilibrium -- unlike in an opened-system, replenishment does not occur in a closed-system. 
