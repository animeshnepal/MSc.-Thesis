...
with continuity equation (\Cref{eq:contiEq}) in an attempt to solve for the fluxes formed due to the dissolution of calcite.
...
Seasonal fluctuations and mean value of \ce{CO2} concentrations in different soils are presented in \Cref{tab:CO2fluctuations}, 
...
This process might last decades until the system comes to a \say{pseudo} steady-state.\\
