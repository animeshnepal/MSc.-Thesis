...
the dissolution proceeds. In \MATLAB we solved for a closed-system with no outflow or inflow of calcium, \ce{CO2} and water. 
...
\ce{CO2} and calcium. A few batch scenarios with varying parameters, such as Initial pH, reactive-area/batch volume (if it's a closed-system), 
flow-velocity (if it's an opened-system), \ce{CO2} concentration at the cave above the karst water (if it's an opened-system) and grid grading 
...
and \ce{H2O}, \ce{CO2} and calcium fluxes are set to Neumann values in the NS-model. We had two setups in \DuMuX i.e., opened 
...
\begin{figure}
    ...
    \caption{Model domain and boundary conditions for \ce{CaCO3} dissolution in an opened-system}
...
to the opened-system -- as we set Dirichlet condition for velocities and Neumann condition for \ce{CO2} and calcium fluxes. On the 
...
\ce{CO2} and calcium into the solution because of dissolution of calcite. On the one hand addition of \ce{CO2} in karst water in an opened-system 
