...
\begin{enumerate}
    ...
    \MATLAB (\MATLAB only has one cell), but the system was still closed having 10 grids in the x-axis and 20-grids in the y-axis. 
    \item Open system: Neumann no-flow boundary conditions were lifted, the number of grids is 10 in the x-axis and 20 in the y-axis, 
