...
We saw in \Cref{chapter:results} that the rate of calcite dissolution, pH and the 
...
developed near the reactive wall, as calculated in \Cref{chapter:results}. The \DuMuX model only had reactive source/sink terms at the cells on the wall. 
